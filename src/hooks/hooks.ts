...
import rankingsJson from '../data/rankings_10222025.json';
import buySellsData from '../data/buyssellsholds_with_ids_080525.json';
import buySellsContendRebuild from '../data/buyssellsholds_with_ids_102225.json';
...
import playerStoplightsJson from '../data/weekly/playerLightsWeek8.json';
import risersFallersJson from '../data/weekly/risersFallersWeek8.json';
import weeklyRankingsJson from '../data/weekly/rankingsWeek8.json';
