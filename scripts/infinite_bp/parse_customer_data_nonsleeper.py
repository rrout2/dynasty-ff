...
json_file_name = 'domain_customer_info_weekly10_nonsleeper.json'
...
league_ids = [str(item[url_param_key]) for item in verified_customer_data]
print(f'Manual URLs: ({len(league_ids)})')
