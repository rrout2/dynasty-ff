...
if __name__ == "__main__":
    process_json_files(
        '../src/data/buyssellsholds_092425.json',  # First JSON file with player objects
        '../src/data/players.json',  # Second JSON file with ID mappings
        '../src/data/buyssellsholds_with_ids_092425.json'  # Output file
    )